...
export const SKILLS: Record<string, SkillDefinition> = {
  sql: {
    ...
    salaryUplift: 3,
    resources: [
    { title: 'SQL for Data Analysis (full playlist)', provider: 'YouTube', kind: 'video', hours: 6, free: true },
    { title: 'Modern SQL Deep Dive', provider: 'Coursera', kind: 'course', hours: 12, free: false },
    { title: 'Window functions reference', provider: 'Official Docs', kind: 'docs', hours: 2, free: true }]
  ...
  python: {
    ...
    salaryUplift: 4,
    resources: [
    { title: 'Python for Data Engineering', provider: 'YouTube', kind: 'video', hours: 8, free: true },
    { title: 'Data Analysis with Python', provider: 'Coursera', kind: 'course', hours: 16, free: false },
    { title: 'Automate a weekly report', provider: 'Hands-on Project', kind: 'project', hours: 6, free: true }]
  ...
  git: {
    ...
    salaryUplift: 1,
    resources: [
    { title: 'Git & GitHub crash course', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Version Control Fundamentals', provider: 'Coursera', kind: 'course', hours: 6, free: false },
    { title: 'Pro Git handbook', provider: 'Official Docs', kind: 'docs', hours: 4, free: true }]
  ...
  etl: {
    ...
    salaryUplift: 6,
    resources: [
    { title: 'Building your first data pipeline', provider: 'YouTube', kind: 'video', hours: 5, free: true },
    { title: 'Data Engineering Foundations', provider: 'Coursera', kind: 'course', hours: 18, free: false },
    { title: 'Ingest an open API into a warehouse', provider: 'Hands-on Project', kind: 'project', hours: 8, free: true }]
  ...
  docker: {
    ...
    salaryUplift: 5,
    resources: [
    { title: 'Docker for data teams', provider: 'YouTube', kind: 'video', hours: 4, free: true },
    { title: 'Containers & Orchestration', provider: 'Coursera', kind: 'course', hours: 14, free: false },
    { title: 'Docker getting started guide', provider: 'Official Docs', kind: 'docs', hours: 3, free: true }]
  ...
  airflow: {
    ...
    salaryUplift: 6,
    resources: [
    { title: 'Airflow from zero to DAGs', provider: 'YouTube', kind: 'video', hours: 6, free: true },
    { title: 'Orchestrating Data Pipelines', provider: 'Coursera', kind: 'course', hours: 20, free: false },
    { title: 'Airflow concepts documentation', provider: 'Official Docs', kind: 'docs', hours: 4, free: true }]
  ...
  'data-modeling': {
    ...
    salaryUplift: 4,
    resources: [
    { title: 'Dimensional modeling explained', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Data Warehouse Design', provider: 'Coursera', kind: 'course', hours: 12, free: false },
    { title: 'Model a retail sales mart', provider: 'Hands-on Project', kind: 'project', hours: 6, free: true }]
  ...
  postgresql: {
    ...
    salaryUplift: 3,
    resources: [
    { title: 'PostgreSQL performance basics', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Relational Databases in Practice', provider: 'Coursera', kind: 'course', hours: 10, free: false },
    { title: 'PostgreSQL manual', provider: 'Official Docs', kind: 'docs', hours: 4, free: true }]
  ...
  spark: {
    ...
    salaryUplift: 5,
    resources: [
    { title: 'PySpark in one evening', provider: 'YouTube', kind: 'video', hours: 4, free: true },
    { title: 'Big Data Processing', provider: 'Coursera', kind: 'course', hours: 16, free: false },
    { title: 'Spark SQL guide', provider: 'Official Docs', kind: 'docs', hours: 3, free: true }]
  ...
  kafka: {
    ...
    salaryUplift: 7,
    resources: [
    { title: 'Kafka fundamentals', provider: 'YouTube', kind: 'video', hours: 5, free: true },
    { title: 'Streaming Systems', provider: 'Coursera', kind: 'course', hours: 22, free: false },
    { title: 'Kafka documentation', provider: 'Official Docs', kind: 'docs', hours: 5, free: true }]
  ...
  dbt: {
    ...
    salaryUplift: 4,
    resources: [
    { title: 'dbt in 60 minutes', provider: 'YouTube', kind: 'video', hours: 2, free: true },
    { title: 'Analytics Engineering with dbt', provider: 'Coursera', kind: 'course', hours: 10, free: false },
    { title: 'dbt developer hub', provider: 'Official Docs', kind: 'docs', hours: 3, free: true }]
  ...
  snowflake: {
    ...
    salaryUplift: 5,
    resources: [
    { title: 'Snowflake architecture explained', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Cloud Data Warehousing', provider: 'Coursera', kind: 'course', hours: 12, free: false },
    { title: 'Snowflake quickstarts', provider: 'Official Docs', kind: 'docs', hours: 4, free: true }]
  ...
  powerbi: {
    ...
    salaryUplift: 3,
    resources: [
    { title: 'Power BI end-to-end project', provider: 'YouTube', kind: 'video', hours: 4, free: true },
    { title: 'Business Intelligence with Power BI', provider: 'Coursera', kind: 'course', hours: 14, free: false },
    { title: 'Power BI learning path', provider: 'Official Docs', kind: 'docs', hours: 5, free: true }]
  ...
  dax: {
    ...
    salaryUplift: 2,
    resources: [
    { title: 'DAX filter context masterclass', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Advanced DAX Patterns', provider: 'Coursera', kind: 'course', hours: 9, free: false },
    { title: 'DAX function reference', provider: 'Official Docs', kind: 'docs', hours: 3, free: true }]
  ...
  excel: {
    ...
    salaryUplift: 1,
    resources: [
    { title: 'Power Query for analysts', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Excel Skills for Business', provider: 'Coursera', kind: 'course', hours: 10, free: false },
    { title: 'Clean a messy workbook', provider: 'Hands-on Project', kind: 'project', hours: 4, free: true }]
  ...
  tableau: {
    ...
    salaryUplift: 2,
    resources: [
    { title: 'Tableau desktop essentials', provider: 'YouTube', kind: 'video', hours: 4, free: true },
    { title: 'Data Visualization with Tableau', provider: 'Coursera', kind: 'course', hours: 12, free: false },
    { title: 'Tableau Public gallery', provider: 'Hands-on Project', kind: 'project', hours: 5, free: true }]
  ...
  statistics: {
    ...
    salaryUplift: 3,
    resources: [
    { title: 'Practical statistics for analysts', provider: 'YouTube', kind: 'video', hours: 4, free: true },
    { title: 'Inferential Statistics', provider: 'Coursera', kind: 'course', hours: 14, free: false },
    { title: 'Design an A/B test readout', provider: 'Hands-on Project', kind: 'project', hours: 5, free: true }]
  ...
  'data-viz': {
    ...
    salaryUplift: 2,
    resources: [
    { title: 'Storytelling with data', provider: 'YouTube', kind: 'video', hours: 3, free: true },
    { title: 'Data Visualization Principles', provider: 'Coursera', kind: 'course', hours: 8, free: false },
    { title: 'Redesign a public dashboard', provider: 'Hands-on Project', kind: 'project', hours: 5, free: true }]
