      ...
      <div className="mx-auto flex h-[66px] w-full max-w-[1440px] items-center justify-between px-6 lg:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={menuRef}>
            ...
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-[12px] font-bold text-white shadow-sm">
                AH
              </span>
              <span className="hidden text-[13.5px] font-medium text-[#0B132B] dark:text-white sm:block">
                {isAr ? 'أحمد ح.' : 'Ahmed H.'}
              </span>
              <ChevronDownIcon
