    ...
    <div className="flex flex-wrap items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className={`flex h-12 items-center gap-2.5 rounded-xl px-6 text-[15px] font-semibold text-white transition-[transform,filter,background-color] duration-150 ease-smooth focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-blue/30 cursor-pointer ${
            nextDisabled
              ? 'cursor-not-allowed bg-slate-300 dark:bg-slate-800 text-slate-500 dark:text-slate-600'
              : 'bg-brand-blue dark:bg-[#3B82F6] shadow-[0_14px_28px_-14px_rgba(27,87,224,0.75)] hover:brightness-105 active:translate-y-[1px]'
          }`}
        >
          {variant === 'finish' && (
