  ...
  return (
    <PanelCard
      ...
      <ChartNoAxesColumnIncreasingIcon
        className="h-[19px] w-[19px] text-brand-green"
        strokeWidth={2.1}
        aria-hidden="true" />
        ...
        <li key={skill.name} className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1.5 flex items-center gap-2.5">
                <span className="h-[7px] flex-1 overflow-hidden rounded-full bg-[#E7EAF3]">
                  <motion.span
                ...
                <span className="w-9 shrink-0 text-right text-[12.5px] font-semibold text-ink-soft">
                  {skill.level}%
                </span>
              </div>
            </div>
