        ...
        <div className="relative z-10 grid items-center gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-6">
          ...
          <div className="space-y-3.5">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full
              bg-blue-50 border border-blue-200/70 text-blue-700
              dark:bg-[#0A1A40]/80 dark:border-cyan-500/30 dark:text-cyan-300
            ...
            <div className="flex flex-wrap items-center gap-2">
              {(isAr
                ? ['بسيطة', 'ذكية', 'مخصصة لك']
                : ['Simple', 'Smart', 'Built for You']
              ).map((tag, i) => (
                <span
                  key={tag}
                  className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-bold
                    ${i === 0 ? 'bg-blue-50 text-blue-700 border border-blue-200/60 dark:bg-blue-950/50 dark:text-blue-300 dark:border-blue-500/30' : ''}
                    ${i === 1 ? 'bg-indigo-50 text-indigo-700 border border-indigo-200/60 dark:bg-indigo-950/50 dark:text-indigo-300 dark:border-indigo-500/30' : ''}
                    ${i === 2 ? 'bg-emerald-50 text-emerald-700 border border-emerald-200/60 dark:bg-emerald-950/50 dark:text-emerald-300 dark:border-emerald-500/30' : ''}
                  `}
                >
              ...
              <span className="text-slate-400 dark:text-slate-600 text-[11px] font-medium mx-0.5">•</span>
