...
/* ========================================================================= */
/* 1. SKILL GAP PANEL (Matching Screenshot 1)                                */
/* ========================================================================= */
const userSkills = [
  { name: 'Python', dots: 3 },
  { name: 'SQL', dots: 3 },
...
const topGaps = ['Advanced SQL', 'Machine Learning', 'AWS'];
    ...
    <div className="flex h-full flex-col justify-between rounded-2xl border border-slate-100 dark:border-white/5 bg-[#F8FAFC] dark:bg-[#080D1A] p-4 text-slate-800 dark:text-slate-200">
      ...
      <div className="grid grid-cols-[1.1fr_1.1fr_1.1fr] items-center gap-2 my-auto">
        ...
        <div className="rounded-xl border border-slate-200/70 dark:border-white/5 bg-white dark:bg-[#0D1527] p-2.5 shadow-sm">
          <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Your Skills</p>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="relative h-[92px] w-[92px]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-[9px] font-bold text-emerald-600 dark:text-emerald-400 mt-0.5">Good Match</span>
            </div>
          </div>
        </div>

        {/* Right: Top Gaps to Focus */}
        <div className="rounded-xl border border-slate-200/70 dark:border-white/5 bg-white dark:bg-[#0D1527] p-2.5 shadow-sm">
          <p className="text-[10px] font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">Top Gaps to Focus</p>
...
/* ========================================================================= */
/* 2. ATS CV BUILDER PANEL (Matching Screenshot 2 Pixel-Perfect)              */
/* ========================================================================= */
const sidebarTabs = ['Personal Info', 'Experience', 'Education', 'Skills', 'Projects', 'Certificates'];
    ...
    <div className="flex h-full flex-col rounded-2xl border border-slate-100 dark:border-white/5 bg-[#F8FAFC] dark:bg-[#080D1A] p-3 text-slate-800 dark:text-slate-200 overflow-hidden">
      <div className="grid grid-cols-[85px_1fr_105px] gap-2.5 h-full items-stretch">
        ...
        <div className="flex flex-col rounded-xl border border-slate-200/70 dark:border-white/5 bg-white dark:bg-[#0D1527] p-2.5 shadow-sm space-y-1.5">
          <div>
            <h4 className="text-[12px] font-bold text-slate-900 dark:text-white leading-tight">Ahmed Hassan</h4>
            <p className="text-[9.5px] text-slate-400 font-medium leading-none mt-0.5">Data Analyst</p>
          </div>

          <div className="flex items-center gap-2 text-[8px] text-slate-400 border-b border-slate-100 dark:border-white/5 pb-1">
            <span className="flex items-center gap-0.5"><MapPin className="w-2 h-2" /> Cairo</span>
          ...
          <div className="space-y-1">
            <p className="text-[9px] font-bold text-slate-700 dark:text-slate-300">Professional Summary</p>
            <div className="h-1.5 w-full rounded-full bg-slate-100 dark:bg-slate-800" />
            <div className="h-1.5 w-5/6 rounded-full bg-slate-100 dark:bg-slate-800" />
          </div>

          <div className="space-y-1 pt-0.5">
            <p className="text-[9px] font-bold text-slate-700 dark:text-slate-300">Experience</p>
        ...
        <div className="flex flex-col justify-between rounded-xl border border-slate-200/70 dark:border-white/5 bg-white dark:bg-[#0D1527] p-2 shadow-sm">
          <div className="flex flex-col items-center">
            <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">ATS Score</p>
            ...
            <span className="text-[8px] font-bold text-emerald-600 dark:text-emerald-400 mt-0.5">Excellent</span>
          </div>

          <div className="space-y-1 border-t border-slate-100 dark:border-white/5 pt-1">
            <p className="text-[8.5px] font-bold text-slate-600 dark:text-slate-400">Optimization Tips</p>
...
/* ========================================================================= */
/* 3. COPILOT PANEL (Matching Screenshot 3)                                  */
/* ========================================================================= */
    ...
    <div className="flex h-full flex-col justify-between rounded-2xl border border-slate-100 dark:border-white/5 bg-[#F8FAFC] dark:bg-[#080D1A] p-3 text-slate-800 dark:text-slate-200">
      ...
      <div className="self-start max-w-[95%] rounded-2xl rounded-tl-none bg-white dark:bg-[#0D1527] border border-slate-200/70 dark:border-white/5 p-2.5 shadow-sm text-slate-700 dark:text-slate-300 text-[10.5px] space-y-1">
        <p className="flex items-center gap-1 font-bold text-slate-900 dark:text-white text-[11px]">
          ...
          Based on your profile & Egyptian market:
        </p>
        <div className="flex flex-col gap-1 pl-4 pt-0.5">
          <p className="font-semibold text-slate-800 dark:text-slate-200">1. <span className="text-[#4338CA] dark:text-indigo-400">Advanced SQL</span></p>
          <p className="font-semibold text-slate-800 dark:text-slate-200">2. <span className="text-[#4338CA] dark:text-indigo-400">Data Storytelling</span></p>
          <p className="font-semibold text-slate-800 dark:text-slate-200">3. <span className="text-[#4338CA] dark:text-indigo-400">AWS Fundamentals</span></p>
        </div>
      </div>
