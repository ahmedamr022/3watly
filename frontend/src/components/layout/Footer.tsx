      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8 items-start">
          ...
          <div className="space-y-3">
            ...
            {/* 4 Official Social Icons (Facebook, Insta, TikTok, YouTube) with authentic hover colors & internal animation */}
            <div className="flex items-center gap-2 pt-2 text-slate-400">
              ...
              <a 
                ...
                aria-label="Facebook"
                title="Facebook"
                className="group relative flex items-center justify-center h-9 w-9 rounded-xl border border-slate-200/90 dark:border-white/10 bg-white dark:bg-[#0B1120] text-slate-500 dark:text-slate-400 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] hover:shadow-[0_4px_16px_rgba(24,119,242,0.4)] hover:-translate-y-1 transition-all duration-300 cursor-pointer"
              >
              ...
              {/* 2. Instagram (Authentic Official Radial/Angled Gradient) */}
              <a 
              ...
              {/* 3. TikTok (#000000 / Dual Cyan & Magenta Drop Shadow) */}
              <a 
