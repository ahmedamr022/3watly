          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 pt-1 text-slate-400">
              ...
              <a 
                ...
                aria-label="LinkedIn"
                title="LinkedIn"
                className="flex items-center justify-center h-8 w-8 rounded-xl border border-slate-100 dark:border-white/10 bg-slate-50/80 dark:bg-[#0B1120]/[0.04] text-slate-500 dark:text-slate-400 hover:text-[#0A66C2] hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/30 hover:scale-110 transition-all duration-200 shadow-sm"
              >
              ...
              <a 
                ...
                aria-label="Facebook"
                title="Facebook"
                className="flex items-center justify-center h-8 w-8 rounded-xl border border-slate-100 dark:border-white/10 bg-slate-50/80 dark:bg-[#0B1120]/[0.04] text-slate-500 dark:text-slate-400 hover:text-[#1877F2] hover:bg-[#1877F2]/10 hover:border-[#1877F2]/30 hover:scale-110 transition-all duration-200 shadow-sm"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a 
                ...
                title="Instagram"
                className="flex items-center justify-center h-8 w-8 rounded-xl border border-slate-100 dark:border-white/10 bg-slate-50/80 dark:bg-[#0B1120]/[0.04] text-slate-500 dark:text-slate-400 hover:text-[#E1306C] hover:bg-[#E1306C]/10 hover:border-[#E1306C]/30 hover:scale-110 transition-all duration-200 shadow-sm"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
